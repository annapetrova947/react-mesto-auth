...
export default function Register(props){
    ...
    function register(e){
        ...
        props.onRegister(refInputEmail.current.value, refInputPassword.current.value)
    }
    ...
    return(
        <form className='form form_auth' onSubmit={register}>
                            ...
                            <button type="submit" className="form__submit-button form__submit-button_auth">
                                Зарегистрироваться
                            </button>
                            <p className='form__question'>Уже зарегистрированы? <Link to="/sign-in"  className='form__question_link'>Войти</Link></p>
                        </form>
    )
}