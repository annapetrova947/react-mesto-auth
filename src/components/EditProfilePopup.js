...
export default function EditProfilePopup(props){
    ...
    return(
        <PopupWithForm name='edit' title='Редактировать профиль' save_button='Сохранить' isOpen={props.isOpen} onClose={props.onClose} onSubmit={handleSubmit}>
            <input id="name" type="text" name="name" className="form__input form__input_type_name" required
                   minLength="2" maxLength="40" onChange={handleChangeName} value={name || ""}/>
            ...
            <input id="about" type="text" name="about" className="form__input form__input_type_about" required
                   minLength="2" maxLength="200" onChange={handleChangeDescription} value={description || ""}/>
